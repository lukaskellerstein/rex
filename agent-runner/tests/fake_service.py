...
`test_service.py` runs THIS as the child rather than `python -m agent_runner`,
...
from agent_runner.adapters.base import AskPolicy, Emit
from agent_runner.events import Completed, Denial, RunResult, Started, StoppedEvent, Text
...
if __name__ == "__main__":
    from agent_runner.service import main
