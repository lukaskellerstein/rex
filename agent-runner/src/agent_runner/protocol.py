...
Run it directly to produce the three committed artefacts::
    ...
    python -m agent_runner.protocol --schema     > schema.json
    python -m agent_runner.protocol --typescript > ../src/shared/agent-protocol.ts
    python -m agent_runner.protocol --catalogue  > catalogue.json
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if "--schema" in args:
        ...
        sys.stderr.write("usage: python -m agent_runner.protocol --schema|--typescript|--catalogue\n")
        return 2
    return 0
