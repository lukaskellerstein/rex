...
- Every edit lands in the checkout assigned to this session. Claude Code uses
  `.worktrees/<name>` unless deliberately launched with `--no-worktree`; Codex
  uses its native Local/Worktree selection and Handoff —
